...
impl Serialize for kvm_vmx_nested_state {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_vmx_nested_state>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_vmx_nested_state {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_vmx_nested_state>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_vmx_nested_state>(v))
        }
    }
}


impl Serialize for kvm_vmx_nested_state__bindgen_ty_1 {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_vmx_nested_state__bindgen_ty_1>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_vmx_nested_state__bindgen_ty_1 {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_vmx_nested_state__bindgen_ty_1>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_vmx_nested_state__bindgen_ty_1>(v))
        }
    }
}


impl Serialize for kvm_nested_state {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_nested_state>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_nested_state {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_nested_state>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_nested_state>(v))
        }
    }
}


impl Serialize for kvm_nested_state__bindgen_ty_1 {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_nested_state__bindgen_ty_1>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_nested_state__bindgen_ty_1 {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_nested_state__bindgen_ty_1>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_nested_state__bindgen_ty_1>(v))
        }
    }
}
...
impl Serialize for kvm_coalesced_mmio_zone__bindgen_ty_1 {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_coalesced_mmio_zone__bindgen_ty_1>(&self);
        bytes.serialize(serializer)
    }
}
...
impl<'de> Deserialize<'de> for kvm_coalesced_mmio_zone__bindgen_ty_1 {
    ...
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_coalesced_mmio_zone__bindgen_ty_1>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_coalesced_mmio_zone__bindgen_ty_1>(v))
        }
    }
}
...
impl Serialize for kvm_coalesced_mmio__bindgen_ty_1 {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_coalesced_mmio__bindgen_ty_1>(&self);
        bytes.serialize(serializer)
    }
}
...
impl<'de> Deserialize<'de> for kvm_coalesced_mmio__bindgen_ty_1 {
    ...
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_coalesced_mmio__bindgen_ty_1>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_coalesced_mmio__bindgen_ty_1>(v))
        }
    }
}
...
impl Serialize for kvm_enc_region {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_enc_region>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_enc_region {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_enc_region>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_enc_region>(v))
        }
    }
}


impl Serialize for kvm_sev_cmd {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_cmd>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_cmd {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_cmd>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_cmd>(v))
        }
    }
}


impl Serialize for kvm_sev_launch_start {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_launch_start>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_launch_start {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_launch_start>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_launch_start>(v))
        }
    }
}


impl Serialize for kvm_sev_launch_update_data {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_launch_update_data>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_launch_update_data {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_launch_update_data>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_launch_update_data>(v))
        }
    }
}


impl Serialize for kvm_sev_launch_secret {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_launch_secret>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_launch_secret {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_launch_secret>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_launch_secret>(v))
        }
    }
}


impl Serialize for kvm_sev_launch_measure {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_launch_measure>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_launch_measure {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_launch_measure>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_launch_measure>(v))
        }
    }
}


impl Serialize for kvm_sev_guest_status {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_guest_status>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_guest_status {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_guest_status>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_guest_status>(v))
        }
    }
}


impl Serialize for kvm_sev_dbg {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_sev_dbg>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_sev_dbg {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_sev_dbg>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_sev_dbg>(v))
        }
    }
}
...
impl Serialize for kvm_hyperv_eventfd {
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
    {
        let bytes = serialize_ffi::<kvm_hyperv_eventfd>(&self);
        bytes.serialize(serializer)
    }
}

impl<'de> Deserialize<'de> for kvm_hyperv_eventfd {
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
    {
        let v: ByteBuf = ByteBuf::deserialize::<D>(deserializer)?;
        if v.len() < mem::size_of::<kvm_hyperv_eventfd>() {
            Err(D::Error::custom(format!("Incomplete buffer: size {}", v.len())))
        } else {
            Ok(deserialize_ffi::<kvm_hyperv_eventfd>(v))
        }
    }
}
